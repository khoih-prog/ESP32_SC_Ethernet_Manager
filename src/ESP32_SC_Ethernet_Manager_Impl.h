...
void ESP32_SC_Ethernet_Manager::handleInfo()
{
  ...
  page += F("<p/>More information about ESP32_SC_Ethernet_Manager at");
  page += F("<p/><a href=\"https://github.com/khoih-prog/ESP32_SC_Ethernet_Manager\">https://github.com/khoih-prog/ESP32_SC_Ethernet_Manager</a>");
  page += FPSTR(EM_HTTP_END);
